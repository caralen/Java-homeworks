...
/**
 * The Class HelloWorker implements IWebWorker. 
 * It generates a html page which has current time and length of the parameter which was passed with the key "name".
 */
public class HelloWorker implements IWebWorker {

	/**
	 * Calls write method on context multiple time with the html code.
	 * It writes current time and the length of the name given in the url with the key "name"
	 */
	@Override
